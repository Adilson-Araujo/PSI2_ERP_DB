...
public class TelaDeEntrada2 {
    ...
    public static JInternalFrame gerarFrameInterno() {
        final JInternalFrame janela = new JInternalFrame("Entrada de Produtos", true, true, true, true);
        ...
        btnNovo.addActionListener(e -> {
            ...
            movimentacaoDados = new MovimentacaoVO(-1, tipoDAO.buscarPorId(1), origemDAO.buscarPorId(3), produto, armazem, 1, quantidade, Timestamp.from(Instant.now()));
